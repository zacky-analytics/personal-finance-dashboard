...
A personal finance analysis project built using Microsoft Excel and Power BI. The project analyzes six months of income, expenses, savings, and cash flow from January to June 2026.
...
The dataset is **fictional** and was created specifically for educational and portfolio purposes.

It does not contain real personal financial information.
...
This project demonstrates the process of turning raw financial transaction data into financial metrics, visual analysis, and actionable financial insights using Excel and Power BI.
